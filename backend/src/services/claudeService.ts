...
Use these outcomes to decide what to do next — weight actions toward what moves the target metric, but keep every active channel represented per the CHANNEL BALANCE rule below (a maintenance-level action on a weaker channel is fine; dropping it to zero is not, unless the user asked to stop it).
